...
export default function PortfolioTemplate(){
    ...
    return(
        ...
        <div className="flex flex-col p-10 mt-[10vh] w-full md:w-1/2">
            ...
            <a href={project.link} target="_blank" rel="noopener noreferrer">
                <button className="bg-[#181818] text-white px-4 py-2 rounded-lg transition mt-[3vh] z-50">
                    View Project
                </button>
            </a>
        )}
  ...
  <div className="w-full md:w-1/2 mt-[4vh] p-[5vw]">
    <LazyImage src={project.image} className="object-cover w-full"/>
  </div>
        ...
        <div className="flex flex-col items-center justify-center gap-[2vh] w-[80%] mb-[8vh]">
            ...
            {project.darkMode && project.darkMode.length > 0 && (
                <button
                    ...
                    className="p-2 rounded-full bg-[#181818] hover:bg-gray-300 transition-all duration-300 flex items-center justify-center"
                >
                    {isDarkMode ? (
